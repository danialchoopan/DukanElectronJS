...
export default function Help() {
  ...
  const sections = [
    ...
    },
    {
      ...
      items: ['دفتر حساب‌ها با ساختار سلسله‌مراتبی', 'سند حسابداری دوطرفه خودکار', 'تراز آزمایشی و صورت سود و زیان', 'ترازنامه و گزارش مطالبات مشتریان', 'ثبت هزینه‌ها با تصویر رسید'],
    },
    {
      title: 'انبارداری',
  ...
  return (
    <div className="h-full p-4 overflow-auto max-w-7xl mx-auto">
      <div className="flex items-center gap-3 mb-6">
        <svg className="w-7 h-7 flex-shrink-0" viewBox="0 0 24 24" fill="none" stroke="#3b82f6" strokeWidth="2">
      ...
      <div className="rounded-2xl border overflow-hidden mb-4" style={{ backgroundColor: cardBg, borderColor: cardBorder }}>
        <div className="px-4 py-3 font-bold flex flex-wrap items-center gap-2" style={{ borderBottom: `1px solid ${cardBorder}`, color: textColor }}>
          <svg className="w-5 h-5 flex-shrink-0" viewBox="0 0 24 24" fill="none" stroke="#3b82f6" strokeWidth="2">
      ...
      <div className="rounded-2xl p-4 border" style={{ backgroundColor: cardBg, borderColor: cardBorder }}>
        ...
        <ul className="space-y-1.5 text-sm" style={{ color: textSecondary }}>
          <li className="flex items-start gap-2"><span className="text-green-500 mt-0.5 flex-shrink-0">•</span> برای بازگشت به صفحه قبل ESC را فشار دهید</li>
          <li className="flex items-start gap-2"><span className="text-green-500 mt-0.5 flex-shrink-0">•</span> کلید Enter در فرم‌ها عمل ذخیره را انجام می‌دهد</li>
          <li className="flex items-start gap-2"><span className="text-green-500 mt-0.5 flex-shrink-0">•</span> در صفحه فروش، با تایپ نام کالا جستجو کنید</li>
          <li className="flex items-start gap-2"><span className="text-green-500 mt-0.5 flex-shrink-0">•</span> میانبرها را می‌توانید در بخش مدیریت سفارشی کنید</li>
          <li className="flex items-start gap-2"><span className="text-green-500 mt-0.5 flex-shrink-0">•</span> برای چاپ گزارش، دکمه چاپ گزارش را کلیک کنید</li>
        </ul>
      </div>
    </div>
  )
