  ...
  const sections = [
    {
      ...
      items: ['اسکن بارکد با اسکنر USB یا دوربین', 'جستجوی نامی با تایپ حداقل ۲ حرف', 'افزودن کالاهای فله‌ای از دکمه‌های سریع', 'پرداخت نقدی با محاسبه پول خرد', 'پرداخت کارتی با ورود دستی مبلغ', 'پرداخت نسیه با انتخاب مشتری', 'نگه‌داشتن فاکتور حداکثر ۳ فاکتور', 'بازیابی فاکتور با کلیدهای F5/F6/F7'],
    },
    {
      title: 'حسابداری',
