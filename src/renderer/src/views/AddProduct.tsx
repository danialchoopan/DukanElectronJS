        ...
        <div className="rounded-2xl p-5 mb-4 border-2" style={{ backgroundColor: cardBg, borderColor: '#3b82f6' }}>
          ...
          <div className="grid grid-cols-4 gap-3">
            ...
            <div>
              ...
              <input value={form.category} onChange={(e) => { setForm((f) => ({ ...f, category: e.target.value })); if (!categories.includes(e.target.value)) setCategories([...categories, e.target.value]) }} className="input-field text-sm" list="categories-list" />
