...
export function seedDatabase(): void {
  ...
  const insertProduct = db.prepare('INSERT INTO products (barcode, title, category, subcategory, unit, purchase_price, sale_price, stock, minStock, isLoose, isSellable) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, 1)')
  const products = [
